...
const MARCH_COMMANDS = [
  ...
  { name: "sessions legacy", description: "List legacy March sessions" },
  { name: "resume", description: "Resume a pi session by id" },
  { name: "resume-legacy", description: "Resume a legacy March session by id" },
  { name: "fork", description: "Show pi branch command guidance" },
