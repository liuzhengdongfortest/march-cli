export function formatHelpLines() {
  return [
    "Commands: /exit, /help, /hotkeys, /templates, /export jsonl, /export html, /export gist <jsonl|html>, /settings, /extensions, /providers, /providers <name>, /model, /models, /session, /session entries, /sessions, /sessions tree, /sessions pi, /sessions legacy, /resume <id>, /resume-pi <id>, /resume-legacy <id>, /clone-pi, /fork-pi, /fork, /fork-legacy, /status, /shell, /shell spawn [name], /save, /name, /copy, /mouse, /pin <path>, /unpin <path>, /pins",
