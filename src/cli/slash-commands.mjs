...
function formatHelpLines() {
  return [
    ...
    "Shortcuts: Esc = abort turn, Ctrl+C = abort turn/exit when idle, Ctrl+O = toggle tool output, Alt+S = shell drawer, Alt+N = next shell, Ctrl+G = external editor, Shift+Tab = cycle thinking, Ctrl+T = thinking selector, Ctrl+L = model selector",
  ];
}
