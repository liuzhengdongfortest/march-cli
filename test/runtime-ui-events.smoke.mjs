...
export async function runRuntimeUiEventsSmoke() {
  ...
  bridge.ui.memoryHint({ source: "assistant", hints: [{ id: "mem_1" }] });
  ...
  assert.deepEqual(calls, [
    ...
    ["retryStart", 1, 3],
    ["memoryHint", "assistant", ["mem_1"]],
  ]);
  assert.deepEqual(decision, { behavior: "allow", toolName: "edit_file", params: { path: "a" }, category: "write" });
  assert.deepEqual(observedEvents, ["text_delta", "tool_start", "retry_start", "memory_hint", "permission_request"]);
